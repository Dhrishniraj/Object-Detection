...
function draw(){
    image(veedeeyo, 0, 0, 380, 380);
    if(status1 == true){
        noname.detect(veedeeyo, gotResults);
        for(i = 0; i < objects.length; i++){
            document.getElementById("no_status").innerHTML = "Status:- Object Detected";
            document.getElementById("binod").innerHTML = "Number of Objects Detected:- " + objects.length;
